...
class PostDetailsAdapter(private val posts: List<PostX>,private val profileClickList: UserProfileClickListner) : RecyclerView.Adapter<PostDetailsAdapter.PostViewHolder>() {
...
//            listner.onPostTagClick(post.tags.toString(), post.body)
            profileClickList.onUserProfileClickListner(post.tags.toString())
